      ...
      {!collapsed && (
        <div className="px-3 pb-3 pt-2 grid grid-cols-2 gap-2 border-t" style={{ borderColor: '#f3f4f6' }}>
          ...
          <div className="col-span-2">
            ...
            <input className={inputCls} style={{ borderColor: '#e5e7eb' }} placeholder="XXXX-XXXX-XXXX-XXXX"
              value={card.card_number || ''}
              onChange={e => { const formatted = formatCardInput(e.target.value); onChange({ card_number: formatted, last4: lastFour(formatted) }) }}
              maxLength={19} />
          </div>
          <div>
